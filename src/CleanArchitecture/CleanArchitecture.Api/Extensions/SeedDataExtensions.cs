    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for (var i = 0; i < 100; i++)
        {
            vehiculos.Add(new
            {
                ...
                Accesorios = new List<int> { (int)Accesorio.Wifi, (int)Accesorio.AppleCar, (int)Accesorio.AndroidCar }
            });
        }
        ...
        const string sql = """
            INSERT INTO public.vehiculos
                ...
                precio_monto, precio_tipo_moneda, mantenimiento_monto, mantenimiento_tipo_moneda, fecha_ultimo_alquiler, accesorios)
            VALUES
                (@Id, @Vin, @Modelo, @Pais, @Departamento, @Provincia, @Ciudad, @Calle, 
                @PrecioMonto, @PrecioTipoMoneda, @PrecioMantenimiento, @PrecioMantenimientoTipoMoneda, @FechaUltima, @Accesorios)
        """;
